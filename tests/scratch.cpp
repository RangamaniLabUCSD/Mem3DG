...
// std::string inputMesh = "/home/cuzhu/2020-Mem3DG-Applications/run/input-file/bud.ply";
// std::string refMesh = "/home/cuzhu/2020-Mem3DG-Applications/run/input-file/patch.ply";
// std::string outputDir = "/home/cuzhu/2020-Mem3DG-Applications/results/bud/coarse/Ksg5e-4_H5";
std::string inputMesh = "C://Users//Kieran//Dev//2020-Mem3DG-Applications//run//input-file//bud.ply";
std::string refMesh =  "C://Users//Kieran//Dev//2020-Mem3DG-Applications//run//input-file//patch.ply";
std::string outputDir = "C://Users//Kieran//Dev//2020-Mem3DG-Applications//results//bud//asymm//testTraj";
//std::string inputMesh = "C://Users//Kieran//Dev//2020-Mem3DG-Applications//results//bud//asymm//testTraj//newBUD.ply";
//std::string refMesh = "C://Users//Kieran//Dev//2020-Mem3DG-Applications//results//bud//asymm//testTraj//newBUD.ply";
  ...
  // List parameters
  double Kb = 8.22e-5, H0 = 4, Kst = 0, Ksl = 0, Kse = 0, epsilon = -1,
         Bc = -1, gamma = 0, Vt = 0.7, Pam = 0, Kf = 0, conc = 25, height = 0,
         radius = 1000, temp = 0, h = 5e-4, Kv = 5e-2, eta = 0, Ksg = 0.1;
  ...
  mem3dg::System f(inputMesh, refMesh, 0,
                   p, o);
