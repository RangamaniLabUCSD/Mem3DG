...
int main() {
  mem3dg::solver::BendingPhysic b;
  mem3dg::solver::StretchingPhysic s;

  // std::list<mem3dg::solver::Physic *> l{&b, &s};
  mem3dg::solver::VariablePhysicsSystem v({&b, &s});
  mem3dg::solver::VariablePhysicsSystem q({&s});
